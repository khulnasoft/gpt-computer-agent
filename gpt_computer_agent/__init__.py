...
class cloud_instance(instance):
    ...
    def change_profile(self, profile):
        response = requests.post(
            self.url + "change_profile",
            data={"profile": profile, "instance": self.instance_id},
            verify=False,
        )
        the_json = response.json()
        return the_json["result"]
    ...
    def add_system_message(self, system_message):
        response = requests.post(
            self.url + "add_system_message",
            data={"system_message": system_message, "instance": self.instance_id},
            verify=False,
        )
        the_json = response.json()
        return the_json["result"]
    ...
    def add_user_id(self, user_id):
        response = requests.post(
            self.url + "add_user_id",
            data={"user_id": user_id, "instance": self.instance_id},
            verify=False,
        )
        the_json = response.json()
        return the_json["result"]
    ...
    def get_logs(self):
        response = requests.post(
            self.url + "get_logs", data={"instance": self.instance_id}, verify=False
        )
        the_json = response.json()
        return the_json["result"]
    ...
    def reset_memory(self):
        response = requests.post(
            self.url + "reset_memory", data={"instance": self.instance_id}, verify=False
        )
        the_json = response.json()
        return the_json["result"]
